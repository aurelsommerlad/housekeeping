...
const { dateOnly, fieldChanged, normalizeForCompare, hasRealChange } = require('./_booking-change-compare');
...
// dateOnly/fieldChanged/normalizeForCompare/hasRealChange: siehe api/_booking-change-compare.js
// (dorthin extrahiert, damit sie ohne Redis/Session isoliert unittestbar sind - reines Verhalten
// unveraendert).
